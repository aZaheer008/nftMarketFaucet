    ...
    <div className="faucet-wrapper">
      <div className="facuet">
        ...
        <span>
          ...
          <div className="notification is-warning is-sixze-6 is-rounded">
            Wallet is not detected!
            <a rel="noreferrer" target="_blank" href="https://docs.metamask.io">Install Market</a>
          </div>
          </>: <button className="button is-small" 
          onClick={() => web3Api.provider.request({method: "eth_requestAccount"})}>
            Connect Wallet </button> 
          }
      </div> : <div>Looking for Web3...</div>
        }
